...
namespace StudentApp.IdentityServer
{
    public class SeedData
    {
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            var adnan = userMgr.FindByNameAsync("adnan").Result;
            if (adnan == null)
            {
                adnan = new IdentityUser
                {
                    UserName = "adnan",
                    Email = "adnan.ali@gmail.com",
                    EmailConfirmed = true
                };
                var result = userMgr.CreateAsync(adnan, "Adnan@123").Result;
                if (!result.Succeeded)
                {
                ...
                result =
                    userMgr.AddClaimsAsync(
                        ...
                        new Claim[]
                        {
                            new Claim(JwtClaimTypes.Name, "Adnan Ali"),
                            new Claim(JwtClaimTypes.GivenName, "Adnan"),
